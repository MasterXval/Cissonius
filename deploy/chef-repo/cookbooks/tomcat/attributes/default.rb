...
when "mac_os_x", "mac_os_x_server"
  set["tomcat"]["user"] = "_www"
  set["tomcat"]["group"] = "_www"
  set["tomcat"]["home"] = "/opt/local/share/java/tomcat6"
  set["tomcat"]["base"] = "/opt/local/share/java/tomcat6"
  set["tomcat"]["config_dir"] = "#{tomcat["home"]}/conf"
  set["tomcat"]["log_dir"] = "#{tomcat["home"]}/logs"
  set["tomcat"]["tmp_dir"] = "/tmp/tomcat6-tmp"
  set["tomcat"]["work_dir"] = "#{tomcat["home"]}/work"
  set["tomcat"]["context_dir"] = "#{tomcat["config_dir"]}/Catalina/localhost"
  set["tomcat"]["webapp_dir"] = "#{tomcat["home"]}/webapps"
else
  set["tomcat"]["user"] = "tomcat6"
  set["tomcat"]["group"] = "tomcat6"
  set["tomcat"]["home"] = "/usr/share/tomcat6"
